 ...
 * @author don-philipe
 */
public class visually_impairedTagParserTest {
    private final BooleanEncodedValue visually_impairedAccessEnc;
    private final DecimalEncodedValue visually_impairedAvSpeedEnc;
    private final DecimalEncodedValue visually_impairedPriorityEnc;
    private final BooleanEncodedValue carAccessEnc;
    private final DecimalEncodedValue carAvSpeedEnc;
    private final EncodingManager encodingManager;
    private final visually_impairedAccessParser accessParser;
    private final visually_impairedAverageSpeedParser speedParser;
    private final visually_impairedPriorityParser prioParser;

    public visually_impairedTagParserTest() {
        visually_impairedAccessEnc = VehicleAccess.create("visually_impaired");
        visually_impairedAvSpeedEnc = VehicleSpeed.create("visually_impaired", 4, 1, true);
        visually_impairedPriorityEnc = VehiclePriority.create("visually_impaired", 4, PriorityCode.getFactor(1), false);
        ...
        encodingManager = EncodingManager.start()
                .add(visually_impairedAccessEnc).add(visually_impairedAvSpeedEnc).add(visually_impairedPriorityEnc).add(RouteNetwork.create(FootNetwork.KEY))
                .add(carAccessEnc).add(carAvSpeedEnc)
                .build();
        accessParser = new visually_impairedAccessParser(encodingManager, new PMap());
        accessParser.init(new DateRangeParser());
        speedParser = new visually_impairedAverageSpeedParser(encodingManager, new PMap()) {
            @Override
        ...
        prioParser = new visually_impairedPriorityParser(encodingManager, new PMap());
    }
    ...
    public void testGetSpeed() {
        ...
        int edgeId = 0;
        visually_impairedAccessEnc.setBool(false, edgeId, edgeIntAccess, true);
        visually_impairedAccessEnc.setBool(true, edgeId, edgeIntAccess, true);
        visually_impairedAvSpeedEnc.setDecimal(false, edgeId, edgeIntAccess, 10);
        assertEquals(10, visually_impairedAvSpeedEnc.getDecimal(false, edgeId, edgeIntAccess), .1);
    }
    ...
    public void testCombined() {
        ...
        edge.set(visually_impairedAvSpeedEnc, 10.0).set(visually_impairedAccessEnc, true, true);
        edge.set(carAvSpeedEnc, 100.0).set(carAccessEnc, true, false);

        assertEquals(10, edge.get(visually_impairedAvSpeedEnc), .1);
        assertTrue(edge.get(visually_impairedAccessEnc));
        assertTrue(edge.getReverse(visually_impairedAccessEnc));
    ...
    public void testGraph() {
        BaseGraph g = new BaseGraph.Builder(encodingManager).create();
        g.edge(0, 1).setDistance(10).set(visually_impairedAvSpeedEnc, 10.0).set(visually_impairedAccessEnc, true, true);
        g.edge(0, 2).setDistance(10).set(visually_impairedAvSpeedEnc, 5.0).set(visually_impairedAccessEnc, true, true);
        g.edge(1, 3).setDistance(10).set(visually_impairedAvSpeedEnc, 10.0).set(visually_impairedAccessEnc, true, true);
    ...
    public void testAccess() {
        ...
        way.clearTags();
        way.setTag("highway", "footway");
        way.setTag("visually_impaired", "no");
        assertTrue(accessParser.getAccess(way).canSkip());
        way.setTag("visually_impaired", "limited");
        assertTrue(accessParser.getAccess(way).isWay());
        ...
        way.clearTags();
        way.setTag("visually_impaired", "yes");
        assertTrue(accessParser.getAccess(way).canSkip());
        way.setTag("highway", "footway");
        assertTrue(accessParser.getAccess(way).isWay());
    }
    ...
    public void testPier() {
        ...
        assertTrue(visually_impairedAccessEnc.getBool(false, edgeId, edgeIntAccess));
        assertTrue(visually_impairedAccessEnc.getBool(true, edgeId, edgeIntAccess));
        assertEquals(5, visually_impairedAvSpeedEnc.getDecimal(false, edgeId, edgeIntAccess));
    }
    ...
    public void testMixSpeedAndSafe() {
        ...
        int edgeId = 0;
        accessParser.handleWayTags(edgeId, edgeIntAccess, way, null);
        assertFalse(visually_impairedAccessEnc.getBool(false, edgeId, edgeIntAccess));
        assertFalse(visually_impairedAccessEnc.getBool(true, edgeId, edgeIntAccess));
        ...
        assertTrue(visually_impairedAccessEnc.getBool(false, edgeId, edgeIntAccess));
        assertTrue(visually_impairedAccessEnc.getBool(true, edgeId, edgeIntAccess));
        assertEquals(5, visually_impairedAvSpeedEnc.getDecimal(false, edgeId, edgeIntAccess), .1);
    ...
    public void testPriority() {
        ...
        way.setTag("highway", "footway");
        assertEquals(PriorityCode.PREFER.getValue(), prioParser.handlePriority(way, null));
        way.setTag("visually_impaired", "designated");
    ...
    public void testBarrierAccess() {
        ...
        // no barrier!?
        // assertTrue(visually_impairedEncoder.handleNodeTags(node) == false);
    ...
    public void testBlockByDefault() {
        ...
        assertFalse(accessParser.isBarrier(node));
        node.setTag("visually_impaired", "yes");
        assertFalse(accessParser.isBarrier(node));
    ...
    public void testApplyWayTags() {
        ...
        GHUtility.setSpeed(5, 5, visually_impairedAccessEnc, visually_impairedAvSpeedEnc, edge01);
        ...
        GHUtility.setSpeed(5, 5, visually_impairedAccessEnc, visually_impairedAvSpeedEnc, edge23);
        ...
        GHUtility.setSpeed(5, 5, visually_impairedAccessEnc, visually_impairedAvSpeedEnc, edge45);
        ...
        assertTrue(edge01.get(visually_impairedAccessEnc));
        assertTrue(edge01.getReverse(visually_impairedAccessEnc));
        assertEquals(2, edge01.get(visually_impairedAvSpeedEnc), 0);
        ...
        assertTrue(edge23.get(visually_impairedAccessEnc));
        assertTrue(edge23.getReverse(visually_impairedAccessEnc));
        ...
        assertEquals(0, edge45.get(visually_impairedAvSpeedEnc), 0.1);
        assertEquals(0, edge45.getReverse(visually_impairedAvSpeedEnc), 0.1);
    }
}
