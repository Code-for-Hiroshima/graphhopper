...
public class Visually_impairedPriorityParser implements TagParser {
    ...
    protected EnumEncodedValue<RouteNetwork> visually_impairedEnc;
    ...
    protected Visually_impairedPriorityParser(DecimalEncodedValue priorityEnc, EnumEncodedValue<RouteNetwork> visually_impairedEnc) {
    ...
    public void handleWayTags(IntsRef edgeFlags, ReaderWay way, IntsRef relationFlags) {
        ...
        Integer priorityFromRelation = routeMap.get(visually_impairedEnc.getEnum(false, edgeFlags));
