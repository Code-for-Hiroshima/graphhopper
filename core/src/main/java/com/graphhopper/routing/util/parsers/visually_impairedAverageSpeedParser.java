...
public class visually_impairedAverageSpeedParser extends FootAverageSpeedParser {

    public visually_impairedAverageSpeedParser(EncodedValueLookup lookup, PMap properties) {
        this(lookup.getDecimalEncodedValue(properties.getString("name", VehicleSpeed.key("visually_impaired"))),
                lookup.getDecimalEncodedValue(FerrySpeed.KEY));
    }

    protected visually_impairedAverageSpeedParser(DecimalEncodedValue speedEnc, DecimalEncodedValue ferrySpeedEnc) {
