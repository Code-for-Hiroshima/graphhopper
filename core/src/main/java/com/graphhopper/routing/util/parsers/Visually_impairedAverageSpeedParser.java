...
public class Visually_impairedAverageSpeedParser extends AbstractAverageSpeedParser implements TagParser {
    ...
    public Visually_impairedAverageSpeedParser(EncodedValueLookup lookup, PMap properties) {
        this(lookup.getDecimalEncodedValue(VehicleSpeed.key(properties.getString("name", "visually_impaired"))));
    }

    protected Visually_impairedAverageSpeedParser(DecimalEncodedValue speedEnc) {
